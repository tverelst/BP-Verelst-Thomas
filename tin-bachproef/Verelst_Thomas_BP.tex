...
\newcommand{\titel}{Augmented Reality op Smartphones in het Middelbaar Onderwjs}
...
Wat zijn de mogelijkheden van Augmented Reality op een handheld device in het middelbaar onderwijs? Waar en hoe wordt dit al gebruikt? Staan leerkrachten open voor het gebruik hiervan?
...
\subsection{Kleine historiek?}
\subsection{Waarom in onderwijs}

\section{Toepassingen}
\subsection{Chemie met QR-codes}
\subsection{Chinees}
\subsection{Evt meerdere}

\section{Software & Frameworks}
\subsection{ARLearn}
\subsection{Vuforia met Unity}
\subsection{Evt meerdere}

\chapter{Onderzoek & analyse}
\label{ch:onderzoek}
\subsection{Methodologie}
\subsection{Resultaten & Analyse}
